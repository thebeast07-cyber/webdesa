        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6>Tambah Data Lembaga</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('cms.lembaga-desa.store') }}" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="alamat_kantor" class="form-label">Alamat Kantor <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="alamat_kantor" value="{{ old('alamat_kantor') }}"
