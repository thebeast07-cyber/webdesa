                ...
                ">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <input type="text" name="ttl_ibu"
                            ...
                            placeholder="Contoh: Pati, 21 Desember 1998" value="{{ old('ttl_ibu') }}" />
                        @error('ttl_ibu')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <textarea id="alamat_ibu" name="alamat_ibu" rows="6"
                            ...
                            placeholder="Alamat Ibu">{{ old('alamat_ibu') }}</textarea>
                        @error('alamat_ibu')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                ">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <input type="text" name="ttl_ayah"
                            ...
                            placeholder="Contoh: Pati, 21 Desember 1998" value="{{ old('ttl_ayah') }}" />
                        @error('ttl_ayah')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <textarea id="alamat_ayah" name="alamat_ayah" rows="6"
                            ...
                            placeholder="Alamat ayah">{{ old('alamat_ayah') }}</textarea>
                        @error('alamat_ayah')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                ">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <input type="text" name="ttl_pelapor"
                            ...
                            placeholder="Contoh: Pati, 21 Desember 1998" value="{{ old('ttl_pelapor') }}" />
                        @error('ttl_pelapor')
                            <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                        @enderror
                    </div>
